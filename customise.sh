...
sudo apt -y install net-tools  geany g++ python3-pip php apache2 fish nginx openssh-server git vim emacs npm vim  tmux libxss1 libappindicator1 libindicator7 libc++-dev libstdc++-7dev
